...
public class State_EnterMineAndDigForNugget : State
{
    ...
    public override void Execute(Miner miner)
    {
        ...
        {
            miner.ChangeState(State_VisitBankAndDepositGold.Instance);
        }

        if(miner.IsThirsty() == true)
        {
            miner.ChangeState(State_QuenchThirst.Instance);
        }
    }
